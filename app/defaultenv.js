...
module.exports = {
  ...
  PORT: 4030,
  LOG_PORT: 4031,
  GIT_PEM_FILE: path.join(APPLICATION_ROOT, "private/git.pem"),
  ...
  PERMISSION_FILE: path.join(APPLICATION_ROOT,"private/users.txt"),
  WIKI_PATH: path.join(APPLICATION_ROOT, "wiki"),
